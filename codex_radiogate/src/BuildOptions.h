...
// Mirror runtime defaults from config.h so Arduino IDE and PlatformIO use one radio source of truth.
#define LM_BAND ((float)RADIO_PROFILE_DEFAULT / 1000000.0F)
#define LM_BANDWIDTH ((float)cfg::kLoRaBandwidth / 1000.0F)
#define LM_LORASF cfg::kLoRaSpreadingFactor
#define LM_CODING_RATE cfg::kLoRaCodingRate
#define LM_PREAMBLE_LENGTH 8U
#define LM_POWER cfg::kLoRaTxPower
#define LM_DUTY_CYCLE 100

//Syncronization Word that identifies the mesh network
#define LM_SYNC_WORD cfg::kLoRaSyncWord
...
#define LM_MAX_PACKET_SIZE cfg::kMaxLoRaPayload
